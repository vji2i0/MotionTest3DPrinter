...
float ADC2Temperature_Extruder1_Temperature(uint16_t adc_value)
{
    ...
    uint16_t temp = (unsigned int)(T0 + (a / (double)adc_value) + b * ((double)adc_value) + c * ((double)adc_value) * ((double)adc_value) + d / ((double)adc_value - 4500.0));
    float temperature = scalar_kalman(&extruder1_kfilter, temp);
...
float ADC2Temperature_Bed_Temperature(uint16_t adc_value)
{
    ...
    uint16_t temp = (unsigned int) (0.85 * (T0 + (a / (double)adc_value) + b * ((double)adc_value) + c * ((double)adc_value) * ((double)adc_value) + d * ((double)adc_value) * ((double)adc_value) * ((double)adc_value)));
    float temperature = scalar_kalman(&bed_kfilter, temp);
