...
void ForwardZ1_Motors(void)     {HAL_GPIO_WritePin(DIR_Z1_GPIO_Port, DIR_Z1_Pin, GPIO_PIN_SET);     incZ1_coordinates(); }
void BackwardZ1_Motors(void)    {HAL_GPIO_WritePin(DIR_Z1_GPIO_Port, DIR_Z1_Pin, GPIO_PIN_RESET);   decZ1_coordinates(); }
void StepOnZ1_Motors(void)      {HAL_GPIO_WritePin(STEP_Z1_GPIO_Port, STEP_Z1_Pin, GPIO_PIN_SET);   }
void StepOffZ1_Motors(void)     {HAL_GPIO_WritePin(STEP_Z1_GPIO_Port, STEP_Z1_Pin, GPIO_PIN_RESET); }
void ForwardZ2_Motors(void)     {HAL_GPIO_WritePin(DIR_Z2_GPIO_Port, DIR_Z2_Pin, GPIO_PIN_SET);     incZ2_coordinates(); }
void BackwardZ2_Motors(void)    {HAL_GPIO_WritePin(DIR_Z2_GPIO_Port, DIR_Z2_Pin, GPIO_PIN_RESET);   decZ2_coordinates(); }
void StepOnZ2_Motors(void)      {HAL_GPIO_WritePin(STEP_Z2_GPIO_Port, STEP_Z2_Pin, GPIO_PIN_SET);   }
void StepOffZ2_Motors(void)     {HAL_GPIO_WritePin(STEP_Z2_GPIO_Port, STEP_Z2_Pin, GPIO_PIN_RESET); }
